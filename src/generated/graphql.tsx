...
export type UpdateUserMutation = { __typename?: 'Mutation' } & {
    updateOneUser?: Maybe<{ __typename?: 'User' } & Pick<User, 'id' | 'email' | 'auth0Sub'>>;
};
...
export type UserQuery = { __typename?: 'Query' } & {
    user?: Maybe<{ __typename?: 'User' } & Pick<User, 'id' | 'email' | 'auth0Sub'>>;
};
...
export function withUser<TProps, TChildProps = {}, TDataName extends string = 'data'>(
    ...
    return ApolloReactHoc.withQuery<TProps, UserQuery, UserQueryVariables, UserProps<TChildProps, TDataName>>(
        UserDocument,
        {
            alias: 'user',
            ...operationOptions,
...
export type UserListProps<TChildProps = {}, TDataName extends string = 'data'> = {
    ...
    TChildProps;
export function withUserList<TProps, TChildProps = {}, TDataName extends string = 'data'>(
    operationOptions?: ApolloReactHoc.OperationOption<
        TProps,
        UserListQuery,
