    ...
    <>
      <div className="bg-white border rounded-lg overflow-hidden">
        <header className="bg-gray-300 text-gray-700 py-3 px-4">
          <h2 className="text-sm font-semibold">Connection {connection.id} Detail</h2>
        </header>
        <table className="w-full text-sm">
          <tbody>
            <tr className="odd:bg-gray-100 even:bg-white border-t">
              ...
              <td className="font-semibold p-3 text-right md:w-1/5">connectedId</td>
              ...
              <td className="font-semibold p-3 text-right md:w-1/5">deletedAt</td>
