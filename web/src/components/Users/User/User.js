      ...
      <div className="bg-white border rounded-lg overflow-hidden">
        ...
        <table className="w-full text-sm">
          <tbody>
            ...
            <tr className="odd:bg-gray-100 even:bg-white border-t">
              <td className="font-semibold p-3 text-right md:w-1/5">auth0Sub</td>
              <td className="p-3">{user.auth0Sub}</td>
            </tr>
            <tr className="odd:bg-gray-100 even:bg-white border-t">
            ...
            <tr className="odd:bg-gray-100 even:bg-white border-t">
              <td className="font-semibold p-3 text-right md:w-1/5">productEmail</td>
              <td className="p-3">{user.productEmail}</td>
            </tr>
            <tr className="odd:bg-gray-100 even:bg-white border-t">
              <td className="font-semibold p-3 text-right md:w-1/5">promotionalEmail</td>
              <td className="p-3">{user.promotionalEmail}</td>
            </tr>
            <tr className="odd:bg-gray-100 even:bg-white border-t">
            ...
            <tr className="odd:bg-gray-100 even:bg-white border-t">
              ...
              <td className="p-3">{user.deletedAt}</td>
            </tr>
